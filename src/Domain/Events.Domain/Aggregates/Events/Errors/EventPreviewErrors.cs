...
public static class EventPreviewErrors
{
    ...
    public static Error PlaceholdersNotFound =>
        new("EventPreview.PlaceholdersNotFound", "Плейсхолдеры мероприятий не найдены.");
}